...
endShape(CLOSE)
 ...
 function mouth(){
  ...
  beginShape()
   ...
   square(width*.38,height*.478,height*.14,width*.2,width*.05,width*.03,width*.08);
  endShape(CLOSE)
  pop()
 ...
 //right pupil
  ...
  ellipse(width*.39,height*.4,vol*100,vol*200)
  console/log(vol)
  ...
  fill(243,243,243)
  var vol = mic.getLevel();
  ellipse(width*.53,height*.4,vol*100,vol*200)
  console/log(vol)
}
